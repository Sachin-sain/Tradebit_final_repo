// ignore_for_file: unused_import, unnecessary_import, must_be_immutable, non_constant_identifier_names, missing_return
...
class _HotDealsState extends State<HotDeals> with TickerProviderStateMixin {
  bool isblink = false;
  ...
  Widget _dataLoaded(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          }else if(snapshot.connectionState == ConnectionState.waiting && firsttimegainer==1){
            return Container(
