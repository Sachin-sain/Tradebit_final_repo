...
class DepositDetail extends StatefulWidget {
  List network;
  String name;
  DepositDetail({Key key, this.network, this.name});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          //     "Wallet Address",
          //     style: TextStyle(
          //       color: save==false?Colors.white.withOpacity(0.7):Colors.blue,
          //       fontSize: 14,
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                color:
                    save == false ? Colors.white.withOpacity(0.7) : Colors.blue,
                fontSize: 12,
                fontWeight: FontWeight.bold,
                fontFamily: "IBM Plex Sans",
              ),
